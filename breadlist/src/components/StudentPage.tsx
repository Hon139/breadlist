...
interface Props{
  onSubmit: (gender:string, extra:string, age:string) => void;
}

function StudentPage({onSubmit} : Props) { 
  ...
  return <><div className = "prim" id='StudentPage'>
    ...
    <div>
        <button onClick={()=> onSubmit(index3,index2,index)} type="submit" className="Submit">Submit</button>
    </div>
</div>
<div id = "overflow"></div>
</>
